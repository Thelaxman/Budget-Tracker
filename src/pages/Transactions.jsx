...
const TYPE_STYLES = {
  spending:   'bg-red-50 text-red-500',
  savings:    'bg-blue-50 text-blue-500',
  investment: 'bg-amber-50 text-amber-500',
  income:     'bg-green-50 text-green-500',
}
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <AnimatePresence>
          {showForm && (
            ...
            >
              ...
              >
                <div className="text-sm font-semibold text-gray-700 mb-4">New transaction</div>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      value={form.cat}
                      onChange={e => updateForm('cat', e.target.value)}
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all appearance-none"
                    >
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          <select
            ...
            className="text-sm bg-white border border-gray-200 rounded-xl px-3 py-2 outline-none focus:border-blue-400 appearance-none"
          >
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <div className="text-gray-500 font-medium mb-1">No transactions found</div>
            ...
            <AnimatePresence>
              {filtered.map((t, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-4 px-5 py-4 border-b border-gray-50 last:border-0 hover:bg-gray-50 transition-colors group"
                >
                  {/* Icon */}
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 w-8 h-8 flex items-center justify-center rounded-lg text-gray-300 hover:text-red-400 hover:bg-red-50 transition-all flex-shrink-0"
                  >
                    {deleting === t.id ? '...' : '✕'}
                  </button>
                </motion.div>
